...
#	O programa é muito intuitivo, o usuário escolhe a música que deseja tocar, a velocidade
#	(foi criado com várias velocidades, por causa do delay do processador que 
#	pode variar em cada máquina). 
#	#######  Caso seja necessário modificar as velocidades, é só modificar o valor de "VelocTempo" que fica dentro do .data na linha 23 ##########
#	- Figura de ritmo semimínima equivale a um tempo no programa (representado por “UmTempo”).
...
#	- Figura de ritmo mínima equivale à soma de duas semimínima, ou seja, representado por dois tempos no programa.
#	- Figura de ritmo semibreve equivale à soma de quatro semimínima, ou seja, representado por quatro tempos no programa.
