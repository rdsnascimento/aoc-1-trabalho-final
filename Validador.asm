...
#	O Programa é bem intuitivo. E tem as seguintes funções:
# 	Habilitar pseudo-instruções
#	1-	Verifica se o RG, CPF ou CNPJ é válido.
#	Observação 1: não funciona com RGs do Rio Grande do Sul, porque estes tem 10 dígitos, só funciona com 9 digitos ou menos,
#  caso tenha menos de 9 dígitos, deve ser preenchido com zero no começo para completar os nove digítos.
#	Observação 2: No caso do CPF da verificação de validade do CPF também é exibido o estado que foi emitido, baseado no nono digito, que é o 
